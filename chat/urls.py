...
urlpatterns = [
    ...
    path('room/<uuid:room_id>/upload/', views.upload_chat_attachment, name='upload_chat_attachment'),
    ...
    path('api/search-users/', views.api_search_users_global, name='api_search_users_global'),
]