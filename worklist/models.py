...
class Study(models.Model):
    ...
    # AI triage persistence (study-level)
    ai_triage_level = models.CharField(max_length=10, blank=True, default='', db_index=True)
    ai_triage_score = models.FloatField(null=True, blank=True)
    ai_triage_flagged = models.BooleanField(default=False)
